...
This repo is a bounded, observable headless Minecraft runtime for advisory
social-material WAM research in wild Minecraft. It is not a Voyager clone, a
Minecraft benchmark project, or a house-building architecture.
...
Repo-root review and agent-operation docs live at the project root. Literature
references and raw source material live under `project-docs/references/`;
superseded plans and historical public docs live under `project-docs/archive/`.

Do not add new public docs under `docs/docs/`. Do not treat archived or
reference material as an active build instruction unless an active spec or
handoff promotes it.
