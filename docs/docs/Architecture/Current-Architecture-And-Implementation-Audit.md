...
| Provider context is compressed and artifact-backed | Good | Context packet now includes settlement state/checklist and blocker histogram. |
...
| Repeated blocked action avoidance | Improving | ActionPlanner receives a typed blocker histogram from settlement state. |
