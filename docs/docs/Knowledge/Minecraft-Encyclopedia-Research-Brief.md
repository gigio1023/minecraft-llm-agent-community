...
1. `docs/docs/Knowledge/Minecraft-Encyclopedia-Index.md`
   - human-readable index;
   - version stamp;
   - what data exists and how runtime/reviewers should use it.
2. `docs/docs/Knowledge/Vanilla-Mechanics-For-Agent-Runtime.md`
   - concise mechanics notes with source URLs;
   - no long wiki excerpts;
   - focus on facts that affect action boundaries and verification.
3. `docs/docs/Knowledge/Early-Survival-Progression-Graph.md`
   - dependency graph from first-day survival to early mining/storage;
   - every node maps to candidate action skills, primitives, and evidence.
4. `docs/docs/Knowledge/Action-Skill-Knowledge-Backlog.md`
   - implemented/planned skill mapping;
   - next best implementation candidates;
   - missing source/data/API gaps.
5. `probe/src/gameplay/knowledge/vanillaKnowledge.ts`
...
6. `probe/src/gameplay/knowledge/extractMinecraftData.ts`
...
- `docs/docs/Agent-Search-Index.md` with the search tokens from this page;
...
docs/docs/Knowledge/Minecraft-Encyclopedia-Research-Brief.md first, then follow
it exactly.
