...
| `REPO_INTERNAL_DOCS` | Root docs guide contributors, agents, branch review, and spec authority | `README.md`, `SPEC.md`, `AGENTS.md`, `CLAUDE.md`, `GEMINI.md`, `CONTRIBUTING.md`, `CURRENT_IMPLEMENTATION_ARCHITECTURE_REVIEW.md` |
...
| Search Token | Meaning | Primary References |
|--------------|---------|--------------------|
| `SOUL_GROUNDED_SOCIAL_SIMULATION` | Minecraft is pressure and evidence for Soul/LifeGoal-grounded social simulation, not a generic benchmark | `SPEC.md`, `Specification/Soul-Grounded-Social-Simulation.md`, `Architecture/Soul-Life-Goal-Runtime-Architecture.md` |
...
| `NO_USER_TASK_AS_TOP_LEVEL_GOAL` | User input is scenario pressure; the actor's durable frame is Soul/LifeGoal continuity | `Architecture/Soul-Life-Goal-Runtime-Architecture.md`, `Specification/Soul-Grounded-Social-Simulation.md` |
...
| Search Token | Meaning | Primary References |
|--------------|---------|--------------------|
| `CURRENT_IMPLEMENTATION_ARCHITECTURE_REVIEW` | Branch-review guide for current implementation boundaries and risks | `CURRENT_IMPLEMENTATION_ARCHITECTURE_REVIEW.md`, `README.md` |
...
15. `docs/blog-doc/Architecture/Current-Handoff-And-Next-Work.md`
16. `docs/blog-doc/Setup/Headless-Server.md`
17. `docs/blog-doc/Setup/Provider-Setup.md`
