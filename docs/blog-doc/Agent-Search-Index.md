...
| `ACTOR_PERSISTENT_STATE_PLAN_BEADS` | Restart-safe actor state and checkpointed multi-cycle PlanBeads between LifeGoal and CycleGoal | `Architecture/Actor-Persistent-State-And-PlanBeads.md`, `Terminology.md`, `probe/src/memory/actorMemory.ts`, `probe/src/runtime/goals/socialCycleContextCompaction.ts` |
