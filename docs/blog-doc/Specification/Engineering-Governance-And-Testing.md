...
`SPEC.md` and files in `docs/blog-doc/Specification/` are long-term spec documents.
...
Keep `SPEC.md`, `README.md`, `docs/blog-doc/intro.md`,
`docs/blog-doc/Documentation-Map.md`, and `docs/blog-doc/Agent-Search-Index.md`
aligned.
