...
- Experiment record:
  `project-docs/operations/run-reports/openai-gpt54mini-no-output-cap-run-2026-06-04.md`
- Report:
...
- `project-docs/runtime/action-skills/action-skill-verification.md`.
...
- `project-docs/runtime/*`;
- `project-docs/operations/*`;
- `project-docs/exports/static/architecture/llm-context-and-actor-workspace.html`;
...
- the planner/control layer still needs stronger argument validation,
  ...
  schema catch-up;
- those follow-ups are now tracked in `project-docs/operations/future-work/future-works.md` rather
...
- `SPEC.md`, `README.md`, `project-docs/orientation/overview.md`, and `project-docs/orientation/agent-search-index.md` align.
...
- `project-docs/runtime/actor-turn/actor-turn-passive-planbeads-goal-brief.md`
...
- Added a compact goal companion document and routed it through
  `project-docs/orientation/documentation-map.md` and `project-docs/orientation/agent-search-index.md` with search token
...
`project-docs/runtime/world-scenarios/world-scenario-truthfulness-and-natural-spawn-implementation-plan.md`.
