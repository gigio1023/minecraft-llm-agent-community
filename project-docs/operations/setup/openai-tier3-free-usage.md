...
`project-docs/operations/setup/provider-setup.md`. Daily reset windows and Korea-time
conversions live in `project-docs/operations/setup/provider-free-tier-reset-windows.md`.
