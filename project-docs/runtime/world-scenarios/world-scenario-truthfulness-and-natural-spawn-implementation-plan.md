...
Status: active implementation plan; first implementation slice landed, smoke
...
For this repo, that means the plan is an internal runtime/world-scenario
document under `project-docs/runtime/world-scenarios/`, with search-index
routing and explicit validation commands. It is not a public docs page and not a
replacement for `SPEC.md` or `AGENTS.md`.

## Current Evidence

Latest relevant docs:

- `project-docs/runtime/world-scenarios/natural-safe-spawn-world-scenario-research-2026-06-10.md`
- `project-docs/operations/run-reports/roofless-hut-flat-scenario-run-2026-06-08.md`
- `project-docs/operations/setup/world-scenario-testing.md`
...
| Documentation routing | `project-docs/orientation/agent-search-index.md` | Add a search token and route the plan beside current setup/research docs. |
...
| `project-docs/operations/setup/world-scenario-testing.md` | Update | Document fixture vs natural safe-spawn lanes and setup-failure semantics. |
| `project-docs/operations/handoffs/current-handoff-and-next-work.md` | Update | Record the current implementation order and latest evidence caveat. |
| `project-docs/orientation/agent-search-index.md` | Update | Route future agents to this plan. |
| `project-docs/orientation/documentation-map.md` | Update | List the plan as an active internal implementation document. |
...
- RCON output failure classification for the known failure strings listed in
  Phase 1.
- Required/optional command semantics in `runWorldScenarioCommands`.
- `natural-safe-spawn-v1` as a natural-world scenario with no terrain mutation
  or fixture resource commands.
- `natural-spawn-validation/v1` actor-workspace artifact generation after bot
  join and before Actor Turn cycles.
- Report/manifest refs for natural spawn validation without inserting setup
  evidence into cycle progress, memory, or PlanBeads.
- Focused unit tests for RCON output truthfulness and natural spawn validation.
- Deterministic one-cycle setup smoke for `natural-safe-spawn-v1`; setup passed
  with provider usage records `0`.

Still pending:

- provider run after setup truthfulness is proven.
