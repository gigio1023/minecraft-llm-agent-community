...
3. `project-docs/orientation/documentation-map.md` - documentation authority order and
   active/supporting/historical document boundaries.
4. `project-docs/orientation/terminology.md` - canonical terms for Actor Turn, Action
   Cards, Evidence Trace, PlanBeads, agent skills, and action skills.
5. `project-docs/research/benchmarks/low-cost-social-simulation-campaign-spec.md` -
...
7. `project-docs/runtime/actor-turn/actor-episode-and-actor-turn-implementation-plan.md`
   - current implementation plan and live-run gate status.
8. `project-docs/runtime/planbeads/actor-persistent-state-and-planbeads.md` -
   durable actor work graph contract.
9. `project-docs/runtime/action-skills/action-selection-gated-action-skill-authoring-plan.md`
   - generated Mineflayer action authoring authority.
10. `project-docs/runtime/overview/minecraft-basic-guide.md` - stable Minecraft
   mechanics guide for provider context.
11. `project-docs/operations/handoffs/current-handoff-and-next-work.md` - dated current
   state, live-run evidence, and unresolved risks.
12. `project-docs/operations/setup/provider-setup.md` - provider auth, usage guard, and
    social-cycle run command reference.
13. `project-docs/operations/setup/provider-free-tier-reset-windows.md` - OpenAI and
