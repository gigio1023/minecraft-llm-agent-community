...
Detailed long-term spec pages live under `../project-docs/specification/`.
...
1. `../../../SPEC.md`
2. `project-docs/specification/advisory-social-material-wam.md`
3. `project-docs/specification/soul-grounded-social-simulation.md`
...
18. `project-docs/operations/setup/headless-server.md`
19. `project-docs/operations/setup/provider-setup.md`
