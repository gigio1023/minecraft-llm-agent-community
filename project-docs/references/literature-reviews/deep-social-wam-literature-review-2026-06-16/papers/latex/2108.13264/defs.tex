...
\newcommand{\marc}[1]{\ifdefined\DRAFT{\textcolor{blue}{(Marc: #1)}}}
\newcommand{\aaron}[1]{\ifdefined\DRAFT{\textcolor{blue}{(Aaron: #1)}}}
\newcommand{\psc}[1]{\ifdefined\DRAFT{\textcolor{red}{(Pablo: #1)}}}
\newcommand{\maxs}[1]{\ifdefined\DRAFT{\textcolor{blue}{(Max: #1)}}}
...
\def \spr{\textsc{spr}}
\def \curl{\textsc{curl}}
\def \drq{\textsc{d}r\textsc{q}}
\def \sunrise{\textsc{sunrise}}
