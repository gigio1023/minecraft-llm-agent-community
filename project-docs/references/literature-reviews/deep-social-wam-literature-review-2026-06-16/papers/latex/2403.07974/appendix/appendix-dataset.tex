...
\subsection{License}
Similar to \citet{hendrycks2021measuring}, we scrape only the problem statements, ground-truth solutions, and test cases from competition websites -- \leetcode{}, \atcoder{}, and \codeforces{}. 
Further, we only scrape publicly visible portions of websites, avoiding any data collection that might be pay-walled or require login or interaction with the website.
Following, \citet{hendrycks2021measuring} we abide by Fair Use §107: “the fair
