...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% start of legacy
% \usepackage[pagebackref,breaklinks,citecolor=uclablue,colorlinks=true,linkcolor=uclablue]{hyperref}
% \usepackage{cite}
...
\newcommand*{\img}[1]{%
    \adjustbox{valign=c}{\includegraphics[height=1.2\baselineskip,keepaspectratio]{#1}}%
}
