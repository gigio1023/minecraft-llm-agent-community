...
class Env(R2D2Env):
    ...
    def __init__(self):
        ...
        self.goal_width = 3.0
        self.goal_position = [self.ground_position[0] + 10.0, self.ground_position[1], self.ground_position[2] + self.ground_size[2] / 2 + self.goal_post_height / 2]
    ...
    def reset(self):
        ...
        ball_y_init = np.random.uniform(self.robot_position_init[1] - 2.0, self.robot_position_init[1] + 2.0)
        self._p.resetBasePositionAndOrientation(self.ball_id, [self.robot_position_init[0] + 5.0, ball_y_init, self.ground_position[2] + self.ground_size[2] / 2 + self.ball_radius], [0.0, 0.0, 0.0, 1.0])
        return observation
