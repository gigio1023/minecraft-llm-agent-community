...
`project-docs/specification/advisory-social-material-wam.md`. This is not a runtime authority
...
- `NITROGEN_2601_02427_ANALYSIS`:
  `project-docs/references/external-project-notes/nitrogen-2601-02427-analysis-2026-06-16.md`
...
- `DEEP_SOCIAL_WAM_LITERATURE_REVIEW_2026_06_16`:
  `project-docs/references/literature-reviews/deep-social-wam-literature-review-2026-06-16/`
