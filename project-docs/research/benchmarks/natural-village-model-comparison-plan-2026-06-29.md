...
```text
project-docs/experiments/curated/2026-06-29/goal-oriented-natural-village-model-comparison/
```
...
```text
project-docs/experiments/curated/2026-06-14/placed-furnace-natural-60/
```
