...
The generated full raw index is `project-docs/Experiments/INDEX.md`; machine
...
```text
project-docs/Experiments/2026-06-13/qwen-comparison-worksite/
```
...
```text
project-docs/Experiments/2026-06-13/visual-evidence-third-person-smoke/
```
...
```text
project-docs/Experiments/2026-06-13/seed-scout-plain-natural/
```
...
```text
project-docs/Experiments/2026-06-13/seed-scout-1214-stable-capture/
```
...
```text
project-docs/Experiments/2026-06-13/visual-evidence-dual-camera-smoke/
```
...
```text
project-docs/Experiments/2026-06-13/qwen-quota-check-20260613.json
```
