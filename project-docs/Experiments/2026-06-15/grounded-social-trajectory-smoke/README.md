...
bun run probe:social-trajectory -- \
  --out ../project-docs/Experiments/2026-06-15/grounded-social-trajectory-smoke/report.json \
  --html ../project-docs/Experiments/2026-06-15/grounded-social-trajectory-smoke/index.html
```
