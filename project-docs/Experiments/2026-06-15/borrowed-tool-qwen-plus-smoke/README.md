...
.agents/skills/provider-quota-preflight/scripts/provider-quota-preflight.ts \
  ...
  > project-docs/Experiments/2026-06-15/borrowed-tool-qwen-plus-smoke/preflight.json

cd probe
bun run probe:social-issue \
  -- --issue borrowed_tool_with_return_or_debt_v1 \
  --model Qwen-Ambassador/Qwen3.7-Plus \
  --out-dir ../project-docs/Experiments/2026-06-15/borrowed-tool-qwen-plus-smoke
```
