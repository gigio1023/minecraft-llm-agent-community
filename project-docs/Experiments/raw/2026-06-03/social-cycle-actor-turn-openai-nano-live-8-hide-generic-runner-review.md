...
- run_id: `social-cycle-4d8836d6-3619-4405-94fe-6f5caa1761a1`
- model: `gpt-5.4-nano`
...
|-------|---------|----------|--------|-----------|---------------|------------|-------------------|-------------|
| cycle-0001 | blocked | failed | use_primitive:move_to | 1 (world_state_summary:1, block_observations:1, block_name_counts:4, nearest_examples:12, verified_blocks:64, truncated_block_observations:1, loaded_coverage:1, non_exhaustive_coverage:1, scan_metadata:1) | valid | no | Craft a wooden pickaxe at the nearby placed crafting table,  | no |
| cycle-0002 | verified_progress | passed | use_primitive:collect_logs | 0 | not_move_to | no | Check inventory for planks and sticks (or take the next sing | no |
| cycle-0003 | verified_progress | passed | use_action_skill:craftPlanksAndSticks | 1 (world_state_summary:1, block_observations:1, block_name_counts:4, nearest_examples:12, verified_blocks:64, truncated_block_observations:1, loaded_coverage:1, non_exhaustive_coverage:1, scan_metadata:1) | not_move_to | no | Check inventory for planks and sticks (or take the next sing | no |
| cycle-0004 | verified_progress | passed | use_action_skill:craftPlanksAndSticks | 1 (world_state_summary:1, block_observations:1, block_name_counts:4, nearest_examples:12, verified_blocks:64, truncated_block_observations:1, loaded_coverage:1, non_exhaustive_coverage:1, scan_metadata:1) | not_move_to | no | Check inventory for planks and sticks (or take the next sing | no |
| cycle-0005 | verified_progress | passed | use_primitive:craft_item | 0 | not_move_to | no | Check inventory for planks and sticks (or take the next sing | no |
| cycle-0006 | verified_progress | passed | use_action_skill:craftPlanksAndSticks | 1 (world_state_summary:1, block_observations:1, block_name_counts:4, nearest_examples:12, verified_blocks:64, truncated_block_observations:1, loaded_coverage:1, non_exhaustive_coverage:1, scan_metadata:1) | not_move_to | no | Check inventory for planks and sticks (or take the next sing | no |
| cycle-0007 | blocked | failed | use_primitive:craft_item | 0 | not_move_to | no | Check inventory for planks and sticks (or take the next sing | no |
| cycle-0008 | blocked | failed | use_primitive:craft_item | 0 | not_move_to | no | Check inventory for planks and sticks (or take the next sing | no |
