...
For example, AlphaCodium~\citep{ridnik2024code} is an intricate \llm{} pipeline for solving competition coding problems. 
...
\begin{figure*}[!tb]
    \centering
    \includegraphics[width=\textwidth]{figures/overview/LCB_holistic_tasks.pdf}
    \caption{
...
The evaluation is performed via an execution-based correctness metric where the model generation is considered correct if \texttt{assert f(input) == generated\_output} passes. 
