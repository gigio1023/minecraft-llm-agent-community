...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.99\textwidth]{figures/quant_eval_collage_dm.pdf}
    \caption{An overview of some of the evaluation scenarios used to study the emergent capabilities of \methodname. They focus on three broad categories, which are (a) reasoning, (b) symbol understanding, and (c) human recognition. The visualized instructions are a subset of the full instructions, which are listed in Appendix \ref{sec:app_eval_instr}.
    }
    \label{fig:quant_eval_collage}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.99\textwidth]{figures/LangTable-R2-fail.pdf}
    \caption{Qualitative example failure cases in the real-world failing to generalize to {\em{unseen object dynamics}}.}
    \label{fig:lang-table-real-fail}
\end{figure}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.99\textwidth]{figures/rt2_filmstrip.pdf}
    \caption{Additional examples of RT-2 with chain-of-thought reasoning}
    \label{fig:cot_filmstrip}
\end{figure}