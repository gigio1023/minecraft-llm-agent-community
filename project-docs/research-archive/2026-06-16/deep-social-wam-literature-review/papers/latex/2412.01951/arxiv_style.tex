...
\declaretheorem[name=Definition, parent=section]{definition}
\declaretheorem[name=Condition, parent=section]{condition}
\declaretheorem[name=Corollary, parent=section]{corollary}
\declaretheorem[name=Claim, parent=section]{claim}
