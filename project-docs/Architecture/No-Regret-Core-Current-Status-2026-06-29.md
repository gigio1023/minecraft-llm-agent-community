...
```text
project-docs/Experiments/2026-06-29/no-regret-core-managed-artifact-control/
```
...
```text
project-docs/Experiments/2026-06-29/no-regret-core-managed-2active-control/
```
...
```text
project-docs/Experiments/2026-06-29/no-regret-core-managed-2active-live-deterministic-control/
```
...
```text
project-docs/Experiments/2026-06-29/no-regret-core-managed-2active-live-smoke-shared-control/
```
...
```text
project-docs/Experiments/2026-06-29/no-regret-core-shared-session-scheduler-smoke/
```
...
```text
project-docs/Experiments/2026-06-29/no-regret-core-shared-session-actor-turn-smoke/
```
...
```text
project-docs/Experiments/2026-06-29/no-regret-core-shared-session-actor-turn-material-pressure-control/
```
...
```text
project-docs/Experiments/2026-06-29/no-regret-core-shared-session-actor-turn-material-breadth-corrected-control/
```
...
```text
project-docs/Experiments/2026-06-29/no-regret-core-provider-preflight-gemini-flash-lite-control/
```
...
```text
project-docs/Experiments/2026-06-29/no-regret-core-shared-session-actor-turn-gemini-flash-lite-control/
```
...
```text
project-docs/Experiments/2026-06-29/no-regret-core-shared-session-actor-turn-gemini-flash-lite-failure-manifest-control/
```
...
```text
project-docs/Experiments/2026-06-29/no-regret-core-shared-session-actor-turn-gemini-flash-lite-multifamily-control/
```
...
```text
project-docs/Experiments/2026-06-29/no-regret-core-provider-preflight-gemini-flash-lite-multifamily-control/
```
...
```text
project-docs/Experiments/2026-06-29/no-regret-core-provider-preflight-qwen-ambassador-control/
```
...
```text
project-docs/Experiments/2026-06-29/no-regret-core-shared-session-actor-turn-qwen-ambassador-plus-control/
```
...
```text
project-docs/Experiments/2026-06-29/no-regret-core-provider-preflight-openai-small-baseline-control/
```
...
```text
project-docs/Experiments/2026-06-29/no-regret-core-qwen-ambassador-decision-note.md
```
