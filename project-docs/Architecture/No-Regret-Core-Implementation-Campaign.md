...
`project-docs/Architecture/No-Regret-Core-Current-Status-2026-06-29.md`. That
status note is intentionally lower authority than this campaign and may become
stale.

Use `project-docs/research-archive/` for why older plans changed. Do not treat
archive reports as active implementation instructions unless a Tier 1 document
...
- static HTML file under `project-docs/static-exports/architecture/` or the
...
- this campaign is routed from `Documentation-Map.md` and
