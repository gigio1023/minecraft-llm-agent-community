...
| Search Token | Meaning | Primary References |
|--------------|---------|--------------------|
| `ACTIVE_CENTRAL_PLAN` | Current research spine: the preregistered lived-vs-told experiment — manipulated partner-directed social history against equivalent decision state, the enacted-vs-narrated delivery gap, and raw-event observer legibility, with stop-results L1-L8 | `project-docs/research/current-spine/central-plan-lived-vs-told-social-history.md`, `project-docs/research/current-spine/lived-vs-told-implementation-plan.md`, `project-docs/research/current-spine/research-documentation-hierarchy.md`, `AGENTS.md` |
| `LIVED_VS_TOLD` | Does enacted social history (lived episodes, agent-written memory) move a co-actor's materially verified behavior differently than an information-equivalent narrated history, and can observers read the effect from raw public events | `project-docs/research/current-spine/central-plan-lived-vs-told-social-history.md`, `project-docs/research/current-spine/lived-vs-told-implementation-plan.md` |
| `LIVED_VS_TOLD_IMPLEMENTATION_PLAN` | Active build order for the lived-vs-told experiment: salvage verdicts on the V2 substrate, Session A provider-free slices (A1-A7, L1 gate), Session B live pilot (B1-B5) | `project-docs/research/current-spine/lived-vs-told-implementation-plan.md`, `project-docs/research/current-spine/central-plan-lived-vs-told-social-history.md` |
| `CO_ACTOR_LEGIBILITY` | Superseded 2026-07-10 (V2): observer prediction of a soul-grounded co-actor across disposition-consistency conditions; killed on verified defects (memoryless positive control, label-consuming treatment arm, soul-as-IV); the legibility question survives re-posed in the V3 plan | `project-docs/research/current-spine/central-plan-embodied-co-actor-legibility.md`, `project-docs/research/current-spine/central-plan-lived-vs-told-social-history.md` |
| `LEGIBILITY_IMPLEMENTATION_PLAN` | Superseded 2026-07-10: V2 build order; its substrate slices landed and carry over into V3; Session 2 never ran | `project-docs/research/current-spine/embodied-co-actor-legibility-implementation-plan.md`, `project-docs/research/current-spine/lived-vs-told-implementation-plan.md` |
| `LEGIBILITY_CYCLE_2_WORK_PLAN` | Superseded 2026-07-10: Phase A live-substrate slices (C2-1..C2-7) landed and carry over; Phase B pilot cancelled; the C2-G gate failure is a recorded V2 design defect | `project-docs/research/current-spine/legibility-cycle-2-live-substrate-work-plan.md`, `project-docs/research/current-spine/lived-vs-told-implementation-plan.md` |
| `DEPTH_NOT_SCALE` | Binding substrate premise: 2-3 actors with dense attributable interaction and matched history pairs per responder; actor-count scale is never a remedy for weak signal | `project-docs/research/current-spine/central-plan-lived-vs-told-social-history.md`, `project-docs/research/current-spine/lived-vs-told-implementation-plan.md`, `AGENTS.md`, `README.md` |
...
5. `project-docs/research/current-spine/central-plan-lived-vs-told-social-history.md`
6. `project-docs/research/current-spine/lived-vs-told-implementation-plan.md`
