...
| `V4_IMPLEMENTATION_EXPLANATION_2026_07_11` | Reviewed implementation state: A1R/A2/A4/B1 accepted, A3/B2 partial, C1/C2 declarations, C3 format/writer, D1 fixture-only writer/index, and remaining live work | `project-docs/research/benchmarks/v4-implementation-explanation.md`, `implementation-notes.md`, `handoff-prompt.md` |
