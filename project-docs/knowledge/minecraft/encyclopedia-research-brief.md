...
- `project-docs/orientation/agent-search-index.md` with the search tokens from this page;
...
project-docs/knowledge/minecraft/encyclopedia-research-brief.md first, then follow
it exactly.
