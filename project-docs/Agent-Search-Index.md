...
| `WORLD_SCENARIO_TRUTHFULNESS_NATURAL_SPAWN_PLAN` | Index for the split active implementation plan for RCON setup truthfulness and `natural-safe-spawn-v1` | `Architecture/World-Scenario-Truthfulness-And-Natural-Spawn-Implementation-Plan.md`, `Architecture/Natural-Safe-Spawn-World-Scenario-Research-2026-06-10.md`, `Setup/World-Scenario-Testing.md`, `probe/src/server/worldScenarios.ts` |
